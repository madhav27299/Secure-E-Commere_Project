...
<div class="form-group">
	    	...
	    	<input type="text" class="form-control unicase-form-control text-input" id="captcha" name="captcha"  required >
	  	</div>
 <div class="form-group">
	    	<label class="info-title" for="captcha-code">captcha-code<span>*</span></label>
