...
if(isset($_POST['submit'])){
  ...
  if($selected_radio == 'CRYPTO-WALLET'){
    header('Location: crypto-wallet.php');
  } else if($selected_radio == 'Internet Banking'){
    header('Location: internet-banking.php');
  } else {
    header('Location: debit-credit-card.php');
  }
}
?>

<form name="payment" method="post">
  <input type="radio" name="paymethod" value="CRYPTO-WALLET" checked="checked">DOGE COIN
